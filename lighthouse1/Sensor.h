...
// add a margin (in ns) on defined timings
#define SYNC_WINDOW_LOW 0 TIMING_MULTIPLER
#define SYNC_WINDOW_HIGH 0 TIMING_MULTIPLER
template<uint8_t SENSOR_PIN>
const sensor_time_t Sensor<SENSOR_PIN>::sync_timings_low[Sensor<SENSOR_PIN>::NUM_TIMINGS] = {52083 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 62500 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 72917 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 
83333 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 93750 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 104167 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 114583 TIMING_MULTIPLER + SYNC_WINDOW_LOW, 125000 TIMING_MULTIPLER + SYNC_WINDOW_LOW};
template<uint8_t SENSOR_PIN>
const sensor_time_t Sensor<SENSOR_PIN>::sync_timings_high[Sensor<SENSOR_PIN>::NUM_TIMINGS] = {62500 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 72917 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 83333 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 
93750 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 104167 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 114583 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 125000 TIMING_MULTIPLER + SYNC_WINDOW_HIGH, 135417 TIMING_MULTIPLER + SYNC_WINDOW_HIGH};
